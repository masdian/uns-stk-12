...
Data diatas harus terlebih dahulu diinputkan di dalam R. Berikut adalah sintaks yang digunakan untuk menginput data di atas. (R bisa diakses secara *online* [**di sini**](https://colab.research.google.com/#create=true&language=r))
...
Ketikkan sintaks berikut untuk menginput data di R melalui [**di sini**](https://colab.research.google.com/#create=true&language=r)
